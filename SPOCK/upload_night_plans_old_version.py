...
def upload_np_euro(t_now, nb_days):
    ...
    for nb_day in range(0, nb_days):
        ...
        # Plans by date
        path_database_plans = os.path.join('speculoos@appcs.ra.phy.cam.ac.uk:/appct/data/SPECULOOSPipeline/Observations/', 'Europa',
        ...
        # zip_files
        path_database_zip_files = os.path.join('speculoos@appcs.ra.phy.cam.ac.uk:/appct/data/SPECULOOSPipeline/Observations/',
        ...
        # upload on HUB
        # cam server to local
        path_database_zip_file = os.path.join('speculoos@appcs.ra.phy.cam.ac.uk:/appct/data/SPECULOOSPipeline/Observations/',
        ...
        path_database_astra_file = os.path.join('speculoos@appcs.ra.phy.cam.ac.uk:/appct/data/SPECULOOSPipeline/Observations/',
...
def upload_np_calli(t_now, nb_days):
    ...
    for nb_day in range(0, nb_days):
        ...
        # Astra
        path_database_astra = os.path.join('speculoos@appcs.ra.phy.cam.ac.uk:/appct/data/SPECULOOSPipeline/Observations/',
                                            'Callisto',
                                            'schedule', 'Astra')
...
def upload_np_gany(t_now, nb_days):
    ...
    for nb_day in range(0, nb_days):
        ...
        # Archive_night_blocks
        path_database_night = os.path.join('speculoos@appcs.ra.phy.cam.ac.uk:/appct/data/SPECULOOSPipeline/Observations/',
                                            'Ganymede',
                                            'schedule', 'Archive_night_blocks')
...
def upload_np_saint_ex(t_now, nb_days):
    ...
    for nb_day in range(0,nb_days):
        ...
        #path_database_plans_SAINT-EX_prince = os.path.join('speculoos@appcs.ra.phy.cam.ac.uk:/appct/data/SPECULOOSPipeline/Observations/',
        #                                   'Saint-Ex', 'schedule', 'Plans_by_date')
